#!/usr/bin/env python
# coding: utf-8
# By darkboss1bd: https://github.com/darkboss1bd
...
# Removed "avatar" (missing font)
FONTS = ['basic', 'o8', 'graffiti', 'chunky', 'epic', 'poison', 'doom']
...
def logo():
    ...
    while color1 == color2:
        color2 = random.choice(color_list)
    try:
        text = pyfiglet.figlet_format('Truecaller\ndarkboss1bd', font=font, justify='center', width=os.get_terminal_size().columns)
    except pyfiglet.FontNotFound:
        text = pyfiglet.figlet_format('Truecaller\ndarkboss1bd', font='standard', justify='center', width=os.get_terminal_size().columns)
    print('\n' * 2 + color2 + text, end='\n')
